...
namespace Special_Tic_Tac_Toe
{
    internal class Game
    {
        ...
        int is1occupied = 0; //These are numbered after the keypad so bottom left is 1 and top right is 9
        int is2occupied = 0;
        ...
        private void GameLoop()
        {
            while (true)
            {
                ...
                if (is1occupied > 0 && is2occupied > 0 && is3occupied > 0 && is4occupied > 0 && is5occupied > 0 && is6occupied > 0 && is7occupied > 0 && is8occupied > 0 && is9occupied > 0)
                {
                    Console.Clear();
